...
/** Skeleton for a project's review overview — KPI row + anomaly alert panel. */
export default function VerifierProjectOverviewLoading() {
  return (
    <div className="mx-auto max-w-[1440px] px-4 py-8 sm:px-8">
      <header className="mb-6">
        {/* The project name is the page title, so it is part of the skeleton. */}
