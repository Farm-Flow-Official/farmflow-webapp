      ...
      {trees.map((t) => {
        ...
        return (
          <Link
            ...
            className={`group flex flex-col overflow-hidden rounded-xl border bg-panel shadow-sm transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-lg motion-reduce:transform-none motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
            ...
            >
              {t.photoFileId ? (
                ...
                <img
                  ...
                  alt=""
                  loading="lazy"
                  className="absolute inset-0 h-full w-full object-cover transition-transform duration-300 ease-out group-hover:scale-105 motion-reduce:transform-none"
                />
              ) : (
