...
export const VERIFIER_GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    summary: 'รอบตรวจใหม่และสัญญาณผิดปกติจะมาหาคุณเอง',
    icon: Bell,
    body: (
      <div className="flex flex-col gap-4">
        <P>
          ไม่ต้องคอยเปิดคิวดูเองว่ามีงานเข้าหรือยัง — กระดิ่งบนหัวจอจะบอกเมื่อ
          <span className="font-medium text-ink">มีรอบตรวจใหม่ส่งเข้ามา</span> และเมื่อ
          <span className="font-medium text-error">AI พบความผิดปกติ</span>ในรอบไหน
        </P>
        <Topic title="สัญญาณเสี่ยงมาเมื่อไหร่">
          <P>
            ระบบรอให้ AI ตรวจครบทั้งรอบก่อนแล้วค่อยแจ้งครั้งเดียว —
            รอบที่มี 300 ต้นจะไม่เด้ง 300 ครั้ง เพราะสิ่งที่คุณตัดสินคือ
            “จะเปิดรอบนี้ดูไหม” ไม่ใช่ทีละต้น · ถ้าไม่มีอะไรผิดปกติก็จะไม่มีแจ้งเตือน
            เพื่อให้การมีแจ้งเตือนยังหมายความว่าอะไรบางอย่างจริง ๆ
          </P>
        </Topic>
        <Note>
          กระดิ่งเก็บ 8 รายการล่าสุด ที่เหลือดูได้ที่เมนู{' '}
          <span className="font-medium text-ink">การแจ้งเตือน</span> ในแถบเครื่องมือ ·
          สถานะอ่านเป็นของบัญชีคุณเอง กดอ่านแล้วไม่ไปลบของผู้ตรวจคนอื่น
        </Note>
      </div>
    ),
  },
