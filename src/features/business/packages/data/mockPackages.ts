...
export const mockPackages: Package[] = [
  {
    ...
    deviceLimit: 2,
    features: [
      'ประเมินคาร์บอนด้วย AI',
      'พื้นที่สูงสุด 15 ไร่',
      'อุปกรณ์เก็บข้อมูล 2 เครื่อง',
      'รายงานพื้นฐาน',
    ],
    isActive: true,
    sortOrder: 0,
  },
  {
    ...
    deviceLimit: 5,
    features: [
      'พื้นที่สูงสุด 50 ไร่',
      'อุปกรณ์เก็บข้อมูล 5 เครื่อง',
      'รายงานเชิงลึก + ส่งออก PDF',
